...
while intentos < 3:
    nombre_de_usuario = input('   ► Ingrese su nombre de usuario, por favor: \n').lower()
    print()
    contrasenia = int(input('   ► Ingrese los 3 dígitos de su contraseña, por favor: \n'))
    time.sleep(1)
    ...
    if nombre_de_usuario == user and contrasenia == password:
        ...
        while True:  # Loop infinito hasta que se elija salir
        ...
        # Exceso de intentos de ingreso - se cierra
        if intentos == 3:
            time.sleep(2)
            ...
            # # Este código permite al usuario ingresar su nombre de usuario y contraseña hasta 3 intentos. Si los datos son correctos, se muestra un mensaje de inicio de sesión exitoso y se muestra el menú principal. El usuario puede elegir entre diferentes opciones, como ingreso de dinero, extracción de dinero, consulta de saldo y salir del programa. Dependiendo de la opción elegida, se realiza la operación correspondiente y se actualiza el saldo actual. También se proporciona la opción para verificar los datos ingresados y volver al menú principal o finalizar el programa.